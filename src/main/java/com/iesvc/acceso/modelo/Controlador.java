...
public class Controlador {
   ...
   //No funciona ni desde bitacora tampoco-----------------------------
    ...
    @PostMapping(value="/usuario/{username}/bitacora", consumes= {"application/json"})
   	@ResponseBody public Usuario createBitacora( @PathVariable (value="username")  @RequestBody Bitacora bitacora) {
 ...
 // Delete Categoria
	...
	// Get All Bitacoras de un Usuario
	 ...
	 @PostMapping(value="//usuario/{username}/bitacora}", consumes= {"application/json"})
		@ResponseBody public Bitacora addBitacora(@Valid @RequestBody  Bitacora bitacora) {
